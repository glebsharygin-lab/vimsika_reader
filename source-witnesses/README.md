...
- `zho_hamilton_xuanzang_1938`: OCR of the facing Chinese text pages in the
  Hamilton scan. This is source-preparation material only until vertical OCR
  order and segmentation have been proofed. A preliminary collation against
  the clean Xuanzang witness is available as `collation-summary.md`,
  `collation-review.tsv`, and `collation.json`.
